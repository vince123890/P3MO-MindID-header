const listFeasibilityStudies = {
  status_code: 200,
  data: {
    items: [
      {
        id: 1,
        project_code: "FS-2024-001",
        business_initiative_name: "Green Energy Expansion Project",
        ...
        npv: 2500000000,
        irr: 18.5,
        sasaran: "Mengembangkan pembangkit listrik tenaga surya dengan kapasitas 100 MW untuk mengurangi ketergantungan pada energi fosil",
        teknologi_lisensor: "SolarTech International",
        raw_material_supplier: "PT Silicon Indonesia",
      ...
      {
        id: 2,
        project_code: "FS-2024-002",
        business_initiative_name: "Digital Transformation Initiative",
        ...
        npv: 1800000000,
        irr: 22.3,
        sasaran: "Modernisasi infrastruktur IT untuk meningkatkan efisiensi operasional dan mendukung pertumbuhan bisnis digital",
        teknologi_lisensor: "Microsoft Azure, Amazon Web Services",
      ...
      {
        id: 3,
        project_code: "FS-2024-003",
        business_initiative_name: "Manufacturing Capacity Expansion",
        ...
        npv: 3200000000,
        irr: 16.8,
        sasaran: "Meningkatkan kapasitas produksi untuk memenuhi peningkatan permintaan pasar domestik dan ekspor",
        teknologi_lisensor: "Siemens Manufacturing Solutions",
      ...
      {
        id: 4,
        project_code: "FS-2024-004",
        business_initiative_name: "Logistics Hub Development",
        ...
        npv: 2100000000,
        irr: 19.2,
        sasaran: "Membangun pusat logistik terintegrasi untuk meningkatkan efisiensi distribusi dan mengurangi biaya operasional",
        teknologi_lisensor: "SAP Logistics Solutions",
      ...
      {
        id: 5,
        project_code: "FS-2024-005",
        business_initiative_name: "Healthcare Technology Upgrade",
        ...
        npv: 950000000,
        irr: 15.7,
        sasaran: "Modernisasi peralatan medis untuk meningkatkan kualitas pelayanan kesehatan dan efisiensi operasional",
        teknologi_lisensor: "GE Healthcare, Siemens Healthineers",
      ...
      {
        id: 6,
        project_code: "FS-2024-006",
        business_initiative_name: "Mining Innovation Project",
        ...
        npv: 2800000000,
        irr: 20.1,
        sasaran: "Implementasi teknologi penambangan canggih untuk meningkatkan efisiensi ekstraksi dan mengurangi dampak lingkungan",
        teknologi_lisensor: "Caterpillar Mining Technology",
...
const detailFeasibilityStudy = {
  status_code: 200,
  data: listFeasibilityStudies.data.items[0],
  version: "1.0.0",
};

export { listFeasibilityStudies, detailFeasibilityStudy };
